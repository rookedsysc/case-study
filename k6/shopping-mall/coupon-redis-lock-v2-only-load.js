...
const CONFIG = {
  ...
  tags: {
    ...
    issueCoupon: { phase: "measure", kind: "issue_coupon_redis_lock_v2" },
    readStatistics: {
      phase: "verify",
      kind: "read_coupon_store_statistics_redis_lock_v2",
    },
  },
};
...
export const options = {
  scenarios: {
    coupon_issue_only_redis_lock_v2: {
  ...
  thresholds: {
    "http_req_failed{phase:measure,kind:issue_coupon_redis_lock_v2}": ["rate < 0.01"],
    "http_req_duration{phase:measure,kind:issue_coupon_redis_lock_v2,status:201}": [
      "p(95) < 500",
    ],
  },
};
